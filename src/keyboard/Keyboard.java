...
public class Keyboard {
	 ...
	 /*FUNCIÓN PARA LEER UN NÚMERO IMPAR*/
	 public static int readOdd() {
		 int num;
		 
		 do {
		 num = readInt();
		 if(num%2 == 0) {
			 System.out.println("Has escrito un número par. Escribe otro número");
		 }
		 }while(num%2 == 0);
	 ...
	 /*FUNCIÓN PARA LEER UN NÚMERO PAR*/
	 public static int readPair() {
		 int num;
		 
		 do {
		 num = readInt();
		 if(num%2 != 0) {
			 System.out.println("Has escrito un número impar. Escribe otro número");
		 }
		 }while(num%2 != 0);
